...
defmodule KVstoreTest do
  ...
  setup do
    File.rm(Application.get_env(:kvstore, :database_path))
...
#  Tests of basic storage operations like put, delete, get, update
  ...
  test "can retrieve entire storage", %{storage: storage} do
    ...
    KVstore.Storage.add(storage, "key01", "value01", 50000)
    KVstore.Storage.add(storage, "key02", "value02", 50000)
    assert KVstore.Storage.list(storage) == %{"key01" => {"value01", 50000}, "key02" => {"value02", 50000}}
  end
